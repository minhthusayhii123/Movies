...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
	...
	<a href="index3.html" class="brand-link"> <img
		...
		style="opacity: .8"> <span class="brand-text font-weight-light">Admin
			Dashboard</span>
	</a>
		...
		<nav class="mt-2">
			<ul class="nav nav-pills nav-sidebar flex-column"
               ...
               with font-awesome or any other icon font library -->
				...
				<li class="nav-item"><a
					href="<c:url value='/admin/video?action=view'/>" class="nav-link">
					...
					<ul class="nav nav-treeview">
						<li class="nav-item"><a
							href="<c:url value='/admin/user?action=view'/>" class="nav-link">
								<i class="far fa-circle nav-icon"></i>
								<p>Overview</p>
						</a></li>
						<li class="nav-item"><a
							href="<c:url value='/admin/user?action=add'/>" class="nav-link">
								<i class="far fa-circle nav-icon"></i>
								<p>New or Edit</p>
						</a></li>
					</ul></li>
