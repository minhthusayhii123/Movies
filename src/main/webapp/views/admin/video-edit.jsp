        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
			  ...
			  <li class="nav-item">
                <a href="<c:url value='/admin/video/add'/>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>New or Edit</p>
                </a>
              </li>
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input name = "href" type="text" id="href" value="${video != null ? video.href:'' }" class="form-control">
              </div>
              <div class="form-group">
				<div class="row">
					<div class="col-9">
...
<script>
	...
	$('#submitBtn').click(function() {
		...
		if(isEdit == 'true') {
			url = '/ASM/admin/video?action=edit&href=' + hrefOrigin;
		} else {
			url = '/ASM/admin/video?action=add';
		}
		var formData = {
